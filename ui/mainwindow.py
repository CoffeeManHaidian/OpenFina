...
class Ui_MainWindow(object):
    ...
    def setup_content_area(self):
        ...
        self.btn_period_close = QPushButton(self.detLadger)
        self.btn_period_close.setObjectName(u"btn_period_close")
        self.btn_period_close.setMinimumHeight(46)
        self.btn_period_close.setText(u"期末结账")
        self.detLadgerLayout.addWidget(self.btn_period_close)

        self.btn_reverse_close = QPushButton(self.detLadger)
        self.btn_reverse_close.setObjectName(u"btn_reverse_close")
        self.btn_reverse_close.setMinimumHeight(46)
        self.btn_reverse_close.setText(u"反结账")
        self.detLadgerLayout.addWidget(self.btn_reverse_close)
        self.detLadgerLayout.addStretch(1)
        self.wgt_DetailFunc.addWidget(self.detLadger)

        self.detReport = QWidget()
        self.detReport.setObjectName(u"detReport")
        self.detReportLayout = QVBoxLayout(self.detReport)
        self.detReportLayout.setSpacing(10)
        self.detReportLayout.setContentsMargins(0, 0, 0, 0)
        self.detReportLayout.setAlignment(Qt.AlignmentFlag.AlignTop)

        self.btn_general_ledger = QPushButton(self.detReport)
        self.btn_general_ledger.setObjectName(u"btn_general_ledger")
        self.btn_general_ledger.setMinimumHeight(46)
        self.btn_general_ledger.setText(u"01009 总分类账")
        self.detReportLayout.addWidget(self.btn_general_ledger)

        self.btn_detail_ledger = QPushButton(self.detReport)
        self.btn_detail_ledger.setObjectName(u"btn_detail_ledger")
        self.btn_detail_ledger.setMinimumHeight(46)
        self.btn_detail_ledger.setText(u"01010 明细分类账")
        self.detReportLayout.addWidget(self.btn_detail_ledger)
        self.detReportLayout.addStretch(1)
        self.wgt_DetailFunc.addWidget(self.detReport)
